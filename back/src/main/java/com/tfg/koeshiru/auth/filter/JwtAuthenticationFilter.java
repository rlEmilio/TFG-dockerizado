package com.tfg.koeshiru.auth.filter;
...
import static com.tfg.koeshiru.auth.TokenJwtConfig.*;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public JwtAuthenticationFilter(AuthenticationManager authenticationManager, UsuarioRepository repository) {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
        ...
        body.put("id", "" + usuario.getId_usuario());
